    ...
    if([json isKindOfClass:[NSDictionary class]]) {
        ...
        if([errors isKindOfClass:[NSArray class]] && [errors count] > 0) {
            ...
            if([errorDictionary isKindOfClass:[NSDictionary class]]) {
                NSString *message = [errorDictionary objectForKey:@"message"];//errorDictionary[@"message"];
                NSInteger code = [[errorDictionary objectForKey:@"code"] integerValue];//[errorDictionary[@"code"] integerValue];
